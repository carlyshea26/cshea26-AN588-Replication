...
#LINEAR MODELS 
##INIs========================================================================================
INI_lm<-read.csv(file="INI_ave_06_20.csv", header=TRUE, dec=".")
LM_ini<-lm(Ave_INI ~ year, data=INI_lm)
summary(LM_ini)

# Model validation figures - Figure 3 - figure supplement 1
layout(matrix(c(1,2,3),3,3,3,byrow=T))
par(mfrow = c(3, 3))
...
## Peak frequencies of the 20-Hz notes from EAR data ==================================================================
EAR<-read.csv(file="20Hz_ave_EARs.csv", header=TRUE, dec=".")
...
#Peak frequencies of the HF note================================================================
HF_lm<-read.csv(file="HF_ave.csv", header=TRUE, dec=".")
HF_LM<-lm(Ave_PF ~ year, data=HF_lm)
summary(HF_LM)

# Model validation figures - Figure 3 - figure supplement 1
#Spend x Residuals Plot
plot(HF_LM$resid~HF_lm$Ave_peak_freq[order(HF_lm$Ave_peak_freq)],
