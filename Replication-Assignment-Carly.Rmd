...
## Introduction
> Copy other replication assignments included as a reference

## Summary of All CSV Files Used in This Replication Assignment
...
Figure 3C: 
> carly; provide summary of what you're looking at here 
```{r}
# Figure 3C:
...
## Supplemental Figure 
### Linear Models / Model validation figures
```{r}
...
## Figure Supplement 2 (Extension of Figure 3) - Averaged peak frequencies of the 20-Hz notes per song from all data
```{r}
