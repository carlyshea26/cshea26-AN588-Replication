...
## Summary of CSV Files/Terms
> Add definitions for things like: 
- INI: 
- AR:
- ONA
...
- I believe this was just a naming mishap that could have arisen from their end.
...
Test OBS - EARS
Supplementary material: Test OBS (ocean bottom seismometer) - EARS (Ecologic Acoustic Recorders)
```{r}
